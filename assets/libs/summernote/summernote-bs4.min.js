...
!function (t, e) {
    ...
    var i = function () {
            ...
            return function () {
                var t = "object" == typeof arguments[1] ? arguments[1] : arguments[0], e = k.isArray(arguments[0]) ? arguments[0] : [];
                return t && t.children && (e = t.children), new i(o, e, t, n)
            }
        }, t = o('<div class="note-editor note-frame card"/>'), e = o('<div class="note-toolbar card-header" role="toolbar"></div>'), n = o('<div class="note-editing-area"/>'),
        r = o('<textarea class="note-codable" role="textbox" aria-multiline="true"/>'), s = o('<div class="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>'),
        ...
        d = o('<div class="note-btn-group btn-group">'), u = o('<div class="dropdown-menu" role="list">', function (t, i) {
            var e = k.isArray(i.items) ? i.items.map(function (t) {
                var e = "string" == typeof t ? t : t.value || "", o = i.template ? i.template(t) : t, n = "object" == typeof t ? t.option : void 0;
            ...
            editor: t, toolbar: e, editingArea: n, codable: r, editable: s, statusbar: a, airEditor: l, airEditable: c, buttonGroup: d, dropdown: u, dropdownButtonContents: function (t) {
                return t
            }, dropdownCheck: h, palette: p, dialog: f, popover: m, icon: v, checkbox: g, options: {}, button: function (t, e) {
    ...
    var D = "ontouchstart" in window || 0 < navigator.MaxTouchPoints || 0 < navigator.msMaxTouchPoints, B = F || L ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input", z = {
        ...
        isFontInstalled: function (t) {
            var e = "Comic Sans MS" === t ? "Courier New" : "Comic Sans MS",
                o = k("<div>").css({position: "absolute", left: "-9999px", top: "-9999px", fontSize: "200px"}).text("mmmmmmmmmwwwwwww").appendTo(document.body), n = o.css("fontFamily", e).width(),
    ...
    var Rt = function () {
        ...
        return r.prototype.nativeRange = function () {
            ...
            o = o || C.ok;
            var n = t && t.includeAncestor, i = t && t.fullyContains, e = this.getStartPoint(), r = this.getEndPoint(), s = [], a = [];
            ...
            var t = this.splitText(), e = t.nodes(null, {fullyContains: !0}), n = Nt.prevPointUntil(t.getStartPoint(), function (t) {
            ...
            var e = this.wrapBodyInlineWithPara().deleteContents(), o = Nt.splitPoint(e.getStartPoint(), Nt.isInline(t));
            ...
            var e = k("<div></div>").html(t)[0], o = N.from(e.childNodes), n = this.wrapBodyInlineWithPara().deleteContents();
        ...
        create: function (t, e, o, n) {
            ...
            var o = t.s.offset, n = t.e.offset, i = Nt.fromOffsetPath(N.head(e), t.s.path), r = Nt.fromOffsetPath(N.last(e), t.e.path);
    ...
    var Ht = function () {
        ...
        return t.prototype.jQueryCSS = function (o, t) {
            ...
            t = t.splitText();
            var o = e && e.nodeName || "SPAN", n = !(!e || !e.expandClosestSibling), i = !(!e || !e.onlyPartialContains);
        ...
        return t.prototype.insertOrderedList = function (t) {
            ...
            var i = this, e = Ft.create(t).wrapBodyInlineWithPara(), o = e.nodes(Nt.isPara, {includeAncestor: !0}), n = N.clusterBy(o, C.peq2("parentNode"));
            ...
            var n = this, e = Ft.create(t).wrapBodyInlineWithPara(), o = e.nodes(Nt.isPara, {includeAncestor: !0}), i = N.clusterBy(o, C.peq2("parentNode"));
            k.each(i, function (t, e) {
                var o = N.head(e);
            ...
            var n = this, e = Ft.create(t).wrapBodyInlineWithPara(), i = e.nodes(Nt.isPara, {includeAncestor: !0}), r = e.paraBookmark(i), s = N.clusterBy(i, C.peq2("parentNode"));
            ...
            var o = N.head(t), n = N.last(t), i = Nt.isList(o.previousSibling) && o.previousSibling, r = Nt.isList(n.nextSibling) && n.nextSibling, s = i || Nt.insertAfter(Nt.create(e || "UL"), n);
            ...
            var d = this, u = [];
            return k.each(t, function (t, e) {
                var o = N.head(e), n = N.last(e), i = c ? Nt.lastAncestor(o, Nt.isList) : o.parentNode, r = i.parentNode;
        ...
        function r(t, e) {
            var o = b(t.rowIndex, e.cellIndex), n = 1 < e.colSpan, i = 1 < e.rowSpan, r = t.rowIndex === f.rowPos && e.cellIndex === f.colPos;
    ...
    var Ot, Ut = function () {
        ...
        return t.prototype.tab = function (t, e) {
            var o = Nt.ancestor(t.commonAncestor(), Nt.isCell), n = Nt.ancestor(o, Nt.isTable), i = Nt.listDescendant(n, Nt.isCell), r = N[e ? "prev" : "next"](i, o);
            ...
            for (var e = Nt.ancestor(t.commonAncestor(), Nt.isCell), o = k(e).closest("tr"), n = o.children("td, th").index(k(e)), i = o[0].rowIndex, r = new Mt(e, Mt.where.Row, Mt.requestAction.Delete, k(o).closest("table")[0]).getActionList(), s = 0; s < r.length; s++) if (r[s]) {
                var a = r[s].baseCell, l = r[s].virtualTable, c = a.rowSpan && 1 < a.rowSpan, d = c ? parseInt(a.rowSpan, 10) : 0;
                switch (r[s].action) {
        ...
        function t(t) {
            ...
            this.insertParagraph = this.wrapCommand(function () {
                ...
                var o = t.url, e = t.text, n = t.isNewWindow, i = t.range || u.createRange(), r = e.length - i.toString().length;
                if (!(0 < r && u.isLimited(r))) {
                    ...
                    var c = Ft.createFromNodeBefore(N.head(a)).getStartPoint(), d = Ft.createFromNodeAfter(N.last(a)).getEndPoint();
        ...
        return t.prototype.initialize = function () {
            ...
            var t = this.createRange().expand(Nt.isAnchor), e = k(N.head(t.nodes(Nt.isAnchor))), o = {range: t, text: t.toString(), url: e.length ? e.attr("href") : ""};
    ...
    var Vt = function () {
        ...
        return t.prototype.initialize = function () {
            ...
            this.$handle = k(['<div class="note-handle">', '<div class="note-control-selection">', '<div class="note-control-selection-bg"></div>', '<div class="note-control-holder note-control-nw"></div>', '<div class="note-control-holder note-control-ne"></div>', '<div class="note-control-holder note-control-sw"></div>', '<div class="', this.options.disableResizeImage ? "note-control-holder" : "note-control-sizing", ' note-control-se"></div>', this.options.disableResizeImage ? "" : '<div class="note-control-selection-info"></div>', "</div>", "</div>"].join("")).prependTo(this.$editingArea), this.$handle.on("mousedown", function (t) {
                if (Nt.isControlSizing(t.target)) {
                    t.preventDefault(), t.stopPropagation();
                    var e = r.$handle.find(".note-control-selection").data("target"), o = e.offset(), n = r.$document.scrollTop(), i = function (t) {
            ...
            if (this.context.invoke("imagePopover.update", t), e) {
                var n = k(t), i = n.position(), r = {left: i.left + parseInt(n.css("marginLeft"), 10), top: i.top + parseInt(n.css("marginTop"), 10)}, s = {w: n.outerWidth(!1), h: n.outerHeight(!1)};
        ...
        return t.prototype.representShortcut = function (t) {
            ...
            return this.ui.buttonGroup({
                ...
                children: [this.button({
                    className: "note-current-color-button", contents: this.ui.icon(this.options.icons.font + " note-recent-color"), tooltip: t, click: function (t) {
                    ...
                    callback: function (o) {
                        ...
                        o.find(".note-holder-custom").each(function (t, e) {
                            ...
                            k(e).change(function () {
                                var t = o.find("#" + k(this).data("event")).find(".note-color-btn").first(), e = this.value.toUpperCase();
                    ...
                    click: function (t) {
                        ...
                        if ("openPalette" === n) {
                            var r = e.find("#" + i), s = k(e.find("#" + r.data("event")).find(".note-color-row")[0]), a = s.find(".note-color-btn").last().detach(), l = r.val();
                            ...
                            var c = "backColor" === n ? "background-color" : "color", d = o.closest(".note-color").find(".note-recent-color"),
            ...
            this.context.memo("button.style", function () {
                return n.ui.buttonGroup([n.button({
                    ...
                    className: "dropdown-style", items: n.options.styleTags, title: n.lang.style.style, template: function (t) {
            ...
            this.context.memo("button.justifyLeft", C.invoke(r, "render")), this.context.memo("button.justifyCenter", C.invoke(s, "render")), this.context.memo("button.justifyRight", C.invoke(a, "render")), this.context.memo("button.justifyFull", C.invoke(l, "render")), this.context.memo("button.outdent", C.invoke(c, "render")), this.context.memo("button.indent", C.invoke(d, "render")), this.context.memo("button.paragraph", function () {
                return n.ui.buttonGroup([n.button({
                    ...
                    data: {toggle: "dropdown"}
                }), n.ui.dropdown([n.ui.buttonGroup({className: "note-align", children: [r, s, a, l]}), n.ui.buttonGroup({className: "note-list", children: [c, d]})])]).render()
            ...
            var e, o = k(t.target.parentNode), n = o.next(), i = o.find(".note-dimension-picker-mousecatcher"), r = o.find(".note-dimension-picker-highlighted"),
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            var t = this.$toolbar.parent(".note-toolbar-wrapper"), e = this.$editor.outerHeight(), o = this.$editor.width(), n = this.$toolbar.height();
            t.css({height: n});
            var i = 0;
        ...
        return t.prototype.initialize = function () {
            var t = this.options.dialogsInBody ? this.$body : this.$editor,
                e = ['<div class="form-group note-form-group">', '<label class="note-form-label">' + this.lang.link.textToDisplay + "</label>", '<input class="note-link-text form-control note-form-control note-input" type="text" />', "</div>", '<div class="form-group note-form-group">', '<label class="note-form-label">' + this.lang.link.url + "</label>", '<input class="note-link-url form-control note-form-control note-input" type="text" value="http://" />', "</div>", this.options.disableLinkTarget ? "" : k("<div/>").append(this.ui.checkbox({
                    ...
                    checked: !0
                }).render()).html()].join(""), o = '<input type="button" href="#" class="btn btn-primary note-btn note-btn-primary note-link-btn" value="' + this.lang.link.insert + '" disabled>';
            ...
            return k.Deferred(function (n) {
                var i = c.$dialog.find(".note-link-text"), r = c.$dialog.find(".note-link-url"), s = c.$dialog.find(".note-link-btn"),
        ...
        return t.prototype.initialize = function () {
            ...
            if (this.options.maximumImageFileSize) {
                var o = Math.floor(Math.log(this.options.maximumImageFileSize) / Math.log(1024)), n = 1 * (this.options.maximumImageFileSize / Math.pow(1024, o)).toFixed(2) + " " + " KMGTP"[o] + "B";
            ...
            return k.Deferred(function (e) {
                var t = i.$dialog.find(".note-image-input"), o = i.$dialog.find(".note-image-url"), n = i.$dialog.find(".note-image-btn");
        ...
        return t.prototype.initialize = function () {
            ...
            var e, o = t.match(/\/\/(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))([\w|-]{11})(?:(?:[\?&]t=)(\S+))?$/),
                n = t.match(/(?:www\.|\/\/)instagram\.com\/p\/(.[a-zA-Z0-9_-]*)/), i = t.match(/\/\/vine\.co\/v\/([a-zA-Z0-9]+)/), r = t.match(/\/\/(player\.)?vimeo\.com\/([a-z]*\/)*(\d+)[?]?.*/),
                s = t.match(/.+dailymotion.com\/(video|hub)\/([^_]+)[^#]*(#video=([^_&]+))?/), a = t.match(/\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.html/), l = t.match(/\/\/v\.qq\.com.*?vid=(.+)/),
                c = t.match(/\/\/v\.qq\.com\/x?\/?(page|cover).*?\/([^\/]+)\.html\??.*/), d = t.match(/^.+.(mp4|m4v)$/), u = t.match(/^.+.(ogg|ogv)$/), h = t.match(/^.+.(webm)$/);
            if (o && 11 === o[1].length) {
                var p = o[1], f = 0;
                if (void 0 !== o[2]) {
        ...
        return t.prototype.initialize = function () {
            ...
            var t = N.head(arguments), e = N.tail(N.from(arguments)), o = this.options.callbacks[C.namespaceToCamel(t, "on")];
            ...
            var t = N.head(arguments), e = N.tail(N.from(arguments)), o = t.split("."), n = 1 < o.length, i = n && N.head(o), r = n ? N.last(o) : N.head(o), s = this.modules[i || "editor"];
            return !i && this[r] ? this[r].apply(this, e) : s && s[r] && s.shouldInitialize() ? s[r].apply(s, e) : void 0
        }, t
    }();
    k.fn.extend({
        summernote: function () {
            var t = k.type(N.head(arguments)), e = "string" === t, o = "object" === t, i = k.extend({}, k.summernote.options, o ? N.head(arguments) : {});
