    ...
    @endif
                ...
                <div class="table">
                    <div class="table_header">
                        <h2>Vehicules</h2>
                      <div class="wrap">
                        <form action="{{route("transmission.recherche")}}" method="GET">
                            @csrf
                            <div class="search">
                         <input type="text" name="transmission" class="searchTerm" placeholder="Transmission">
                    ...
                    <div class="table_section">
                        <table>
                            ...
                            <tbody>
                                  ...
                                  <tr>
                                    <div class="offcanvas offcanvas-end" id="demoModifer">
                                        <div class="offcanvas-header">
                                          <h3 class="offcanvas-title" style="color: #0298cf">Modifer une transmission</h3>
                                          <button type="button"  class="btn-close" data-bs-dismiss="offcanvas"></button>
                                        </div>
                                        <div class="offcanvas-body">

                                            <form method="POST" action="{{url('transmissionEdit/'.$transmission->id)}}">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-body">
                                                    <div class="row justify-content-center row-ajouter">
                                                        <div class="col-13 align-self-center mb-5" style="display: inherit;">
                                                            ...
                                                            <input style="width:350px ;height: 40px;" type="text" class="form-control" value="{{$transmission->transmisson}}"  name="transmission" placeholder="transmission">
                                                        </div>
                               ...
                               <td>{{$transmission->transmisson}}</td>
                               <form action="{{url('transmissionDelete/'.$transmission->id)}}" method="GET">
                               <td>
                                   <button href="{{url('transmissionDelete/'.$transmission->id)}}" type="button" data-id="{{$transmission->transmisson}}"  data-bs-toggle="offcanvas" data-bs-target="#demoModifer"><i class="fa-solid fa-pen-to-square"></i></button> <button type="submit" href="{{url('transmission.supprimer/'.$transmission->id)}}" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette transmission ?');"><i class="fa-solid fa-trash"></i></button>
  ...
  <!-- The Modal -->
    ...
    <div class="offcanvas offcanvas-top" id="demoSupprimer">
      ...
      <div class="offcanvas offcanvas-end" id="demoAjouter">
        <div class="offcanvas-header">
          <h3 class="offcanvas-title" style="color: #0298cf">Ajouter une transmission</h3>
          <button type="button"  class="btn-close" data-bs-dismiss="offcanvas"></button>
        </div>
        <div class="offcanvas-body">
            <form method="POST" action="{{route('transmission.ajouter')}}">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row justify-content-center row-ajouter">
                        <div class="col-13 align-self-center mb-5" style="display: inherit;">
                            ...
                            <input style="width:350px ;height: 40px;" type="text" class="form-control" name="transmission" placeholder="transmission">
                        </div>
