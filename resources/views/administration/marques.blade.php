...
@section('content')
            ...
            <div class="col-md-9">
                ...
                <div class="table">
                    <div class="table_header">
                      ...
                      <div class="wrap">
                            <div class="search">
                        <form action="{{route("marques.recherche")}}" method="GET">
                                    @csrf
                    ...
                    <div class="table_section">
                        <table>
                            ...
                            <tbody>
                               ...
                               <td>{{$marque->id}}</td>
                               <td>{{$marque->marque}}</td>
                               <form action="{{url('marqueDelete/'.$marque->id)}}" method="GET">
                               <td>
                                   <button href="{{url('marqueEdit/'.$marque->id)}}" type="button" data-id="{{$marque->marque}}"  data-bs-toggle="offcanvas" data-bs-target="#demoModifer"><i class="fa-solid fa-pen-to-square"></i></button> <button type="submit" href="{{url('marque.supprimer/'.$marque->id)}}" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette marque ?');"><i class="fa-solid fa-trash"></i></button>
    ...
    <div class="offcanvas offcanvas-end" id="demoModifer">
        <div class="offcanvas-header">
          <h3 class="offcanvas-title" style="color: #0298cf">Modifer une marque</h3>
          <button type="button"  class="btn-close" data-bs-dismiss="offcanvas"></button>
        </div>
        <div class="offcanvas-body">

            <form method="POST" action="{{url('marqueEdit/'.$marque->id)}}">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    ...
                    <div class="row justify-content-center row-ajouter">
                        <div class="col-13 align-self-center mb-5" style="display: inherit;">
                            ...
                            <input style="width:300px ;height: 40px;" type="text" class="form-control" value="{{$marque->marque}}" name="marque" placeholder="Marque">
  ...
  <!-- The Modal -->
    ...
    <div class="offcanvas offcanvas-top" id="demoSupprimer">
      ...
      <div class="offcanvas offcanvas-end" id="demoAjouter">
        <div class="offcanvas-header">
          <h3 class="offcanvas-title" style="color: #0298cf">Ajouter une marque</h3>
          <button type="button"  class="btn-close" data-bs-dismiss="offcanvas"></button>
        </div>
        <div class="offcanvas-body">
                ...
                <div class="modal-body">
                    ...
                    <div class="row justify-content-center row-ajouter">
                        <div class="col-13 align-self-center mb-5" style="display: inherit;">
                            ...
                            <input style="width:350px ;height: 40px;" type="text" class="form-control" name="marque" placeholder="Marque">
                        </div>
