            ...
            <div class="col-md-9">
                ...
                <div class="table">
                    <div class="table_header">
                        ...
                        <div class="wrap">
                            <div class="search">
                        <form action="{{route("couleurs.recherche")}}" method="GET">
                                    @csrf
                         <input type="text" class="searchTerm" placeholder="couleur" name="couleur">
                    ...
                    <div class="table_section">
                        <table>
                            ...
                            <tbody>
                                  ...
                                  <tr>
                                    <div class="offcanvas offcanvas-end" id="demoModifer">
                                        <div class="offcanvas-header">
                                          <h3 class="offcanvas-title" style="color: #0298cf">Modifer une couleur</h3>
                                          <button type="button"  class="btn-close" data-bs-dismiss="offcanvas"></button>
                                        </div>
                                        <div class="offcanvas-body">

                                            <form method="POST" action="{{url('couleurEdit/'.$couleur->id)}}">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-body">
                                                    <div class="row justify-content-center row-ajouter">
                                                        <div class="col-13 align-self-center mb-5" style="display: inherit;">
                                                            ...
                                                            <input style="width:350px ;height: 40px;" type="text" class="form-control" value="{{$couleur->couleur}}"  name="couleur" placeholder="couleur">
                                                        </div>
                               ...
                               <form action="{{url('couleurDelete/'.$couleur->id)}}" method="GET">
                               <td>
                                   <button href="{{url('couleurDelete/'.$couleur->id)}}" type="button" data-id="{{$couleur->couleur}}"  data-bs-toggle="offcanvas" data-bs-target="#demoModifer"><i class="fa-solid fa-pen-to-square"></i></button> <button type="submit" href="{{url('couleur.supprimer/'.$couleur->id)}}" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette couleur ?');"><i class="fa-solid fa-trash"></i></button>
  ...
  <!-- The Modal -->
    ...
    <div class="offcanvas offcanvas-top" id="demoSupprimer">
      ...
      <div class="offcanvas offcanvas-end" id="demoAjouter">
        <div class="offcanvas-header">
          <h3 class="offcanvas-title" style="color: #0298cf">Ajouter une couleur</h3>
          <button type="button"  class="btn-close" data-bs-dismiss="offcanvas"></button>
        </div>
        <div class="offcanvas-body">
            <form method="POST" action="{{route('couleur.ajouter')}}">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row justify-content-center row-ajouter">
                        <div class="col-13 align-self-center mb-5" style="display: inherit;">
                            ...
                            <input style="width:350px ;height: 40px;" type="text" class="form-control" name="couleur" placeholder="couleur">
                        </div>
