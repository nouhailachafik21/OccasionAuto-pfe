        ...
        <table>
            <thead>
                <tr >
                    ...
                    <th colspan="2">Informations mission</th>
                </tr>
            ...
            <tbody>
              ...
              <tr>
                    ...
                    <td >
                        ...
                        @if($mission->status==0)
                          <p style="background-color: rgb(240, 0, 0);color:white;font-size: 10px">En cours de traitement</p>
                        @else
                        <p style="background-color: rgb(12, 180, 35);font-size: 12px"> traité</p>
                        @endif
